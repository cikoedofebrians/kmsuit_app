...
class _$PaginationEntityImpl implements _PaginationEntity {
  const _$PaginationEntityImpl(
      ...
      required final List<UserEntity> data})
      : _data = data;
  ...
  @override
  String toString() {
    return 'PaginationEntity(page: $page, perPage: $perPage, total: $total, totalPages: $totalPages, data: $data)';
  }
...
abstract class _PaginationEntity implements PaginationEntity {
  const factory _PaginationEntity(
      ...
      required final List<UserEntity> data}) = _$PaginationEntityImpl;
